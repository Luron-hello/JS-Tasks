...
// // console.log('<img src="' + user['avatar'] + '" alt=">');

// // for (let property in user){
// //     console.log(property);
// //     console.log(user[property]);
// //     console.log('Свойство: '+ property + ', значение: ' + (user[property]));
// // }

// // console.log(`Кличка кошки: ${cat.name}, возраст$(cat.age)`)

// // Задание 1
let n = +prompt("Ваше число?");
for (let i = 0; i < 101; i++){
    if (i == n){
        console.log("Ваше число находится в диапозоне от 0 до 100");
    }
    else{
        console.log("Ваше число не находится в диапозоне от 0 до 100");
    }
}
...
// 5) Определить и вывести в консоль индекс максимального числа массива (или индексы, если число встречается более одно
...
for(let i = 0; i < numbers.length; i++){
    if(numbers[i] === max){
        console.log(`Индексы максимального числа: ` + (i));
    }
}
...
for (let i = 0; i < fruits.length; i++) {
    console.log(fruits[i].word + ' - ' + fruits[i].length);
  }